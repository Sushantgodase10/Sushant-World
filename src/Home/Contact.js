...
const Contact = () => {
  return (
    ...
    <div class=" mx-auto max-w-screen-md bg-gray-100 border border-black p-4 m-4 rounded-lg shadow-md" >
      ...
      <form action="#" class="space-y-8">
        ...
        <button
          type="submit"
          class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 bg-blue-400 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
        >
          Send message
        </button>
      </form>
    ...
    {/* <div class="flex-wrap-reverse mx-auto max-w-screen-md bg-gray-100 border border-black p-4 m-4 rounded-lg">
